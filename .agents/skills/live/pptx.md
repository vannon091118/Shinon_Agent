...
activation_count: 2
tags: [catalog]
output_path: ".agents/skills/claude-tools/pptx/SKILL.md"
---
...
## Pfad zum Output
.agents/skills/claude-tools/pptx/SKILL.md

## Re-Aktivierung (schnell)
```bash
bash .agents/skills/live-context.sh pptx   # holt diesen Snapshot
# Falls mehr Details nötig:  cat .agents/skills/pptx/SKILL.md
```
