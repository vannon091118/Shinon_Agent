...
activation_count: 2
tags: [catalog]
output_path: ".agents/skills/communication-apis/zoom/video-sdk/web/SKILL.md"
---

# ⏸️  video-sdk-web · IDLE
...
## Pfad zum Output
.agents/skills/communication-apis/zoom/video-sdk/web/SKILL.md

## Re-Aktivierung (schnell)
```bash
bash .agents/skills/live-context.sh video-sdk-web   # holt diesen Snapshot
# Falls mehr Details nötig:  cat .agents/skills/video-sdk-web/SKILL.md
```
