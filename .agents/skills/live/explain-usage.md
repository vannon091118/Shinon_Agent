...
activation_count: 2
tags: [catalog]
output_path: ".agents/skills/claude-tools/explain-usage/SKILL.md"
---

# ⏸️  explain-usage · IDLE
...
## Pfad zum Output
.agents/skills/claude-tools/explain-usage/SKILL.md

## Re-Aktivierung (schnell)
```bash
bash .agents/skills/live-context.sh explain-usage   # holt diesen Snapshot
# Falls mehr Details nötig:  cat .agents/skills/explain-usage/SKILL.md
```
