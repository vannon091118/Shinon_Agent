...
activation_count: 2
tags: [catalog]
output_path: ".agents/skills/communication-apis/zoom/meeting-sdk/unreal/SKILL.md"
---
...
## Pfad zum Output
.agents/skills/communication-apis/zoom/meeting-sdk/unreal/SKILL.md

## Re-Aktivierung (schnell)
```bash
bash .agents/skills/live-context.sh unreal   # holt diesen Snapshot
# Falls mehr Details nötig:  cat .agents/skills/unreal/SKILL.md
```
