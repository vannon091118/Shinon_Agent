...
description:  "[codex:game-studio] Build React-hosted 3D browser games with React Three Fiber. Use when the user wants pmndrs-based scene composition, shared React state, and 3D HUD integration inside a React app."
category: gaming
stack: KREATIV
risk: low
