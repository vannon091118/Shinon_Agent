---
name: game-playtest
description:  "[codex:game-studio] Run browser-game playtests and frontend QA. Use when the user asks for smoke tests, screenshot-based verification, browser automation, HUD or overlay review, or structured issue-finding in a browser game."
category: gaming
stack: KREATIV
risk: low
