...
description: "[codex:build-web-apps] Manages shadcn components and projects — composition rules, critical patterns, and best practices for shadcn/ui in frontend applications. Distinct from vercel-shadcn which covers CLI, deployment, and Vercel-specific shadcn workflows. Applies when working with shadcn/ui, component registries, presets, --preset codes, or any project with a components.json file. Also triggers for \"shadcn init\", \"create an app with --preset\", or \"switch to --preset\"."
category: web-dev
stack: KREATIV
risk: medium
