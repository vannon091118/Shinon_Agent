---
name: mixpanel-auth
description: "[codex:mixpanel-headless] \"Manage Mixpanel Headless authentication: check session state, list/add/use accounts, run OAuth login, switch projects/workspaces, manage targets, and check bridge credentials.\""
