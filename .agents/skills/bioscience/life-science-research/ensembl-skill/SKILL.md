---
name: ensembl-skill
description:  "[codex:life-science-research] Submit compact Ensembl REST API requests for lookup, overlap, cross-reference, and variation endpoints. Use when a user wants concise Ensembl summaries"
category: bioscience
