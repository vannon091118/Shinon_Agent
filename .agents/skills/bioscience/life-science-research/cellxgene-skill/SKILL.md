...
description:  "[codex:life-science-research] Submit compact CELLxGENE Discover API requests for public collection and dataset metadata. Use when a user wants concise single-cell collection summaries"
category: bioscience
