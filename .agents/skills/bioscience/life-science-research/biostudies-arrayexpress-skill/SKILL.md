...
description:  "[codex:life-science-research] Submit compact BioStudies and ArrayExpress API requests for free-text search and accession-based study retrieval. Use when a user wants concise BioStudies summaries"
category: bioscience
