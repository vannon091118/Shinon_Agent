---
name: uniprot-skill
description:  "[codex:life-science-research] Submit compact UniProt REST API requests for UniProtKB, UniRef, UniParc, and FASTA stream endpoints. Use when a user wants concise UniProt summaries; save raw JSON or FASTA only on request."
category: bioscience
