---
name: chebi-skill
description:  "[codex:life-science-research] Submit compact ChEBI 2.0 API requests for chemical search, compound lookup, ontology traversal, and structure metadata. Use when a user wants concise ChEBI summaries"
category: bioscience
