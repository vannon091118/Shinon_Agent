---
name: ngs-fastq-qc
description:  "[codex:ngs-analysis] Validate FASTQ inputs, run local FastQC/MultiQC QC, interpret QC signals, and optionally execute fastp or Cutadapt trimming branches without overwriting raw reads."
category: bioscience
