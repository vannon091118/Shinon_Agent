---
name: ngs-scrna-seq
description:  "[codex:ngs-analysis] Route single-cell or single-nucleus RNA-seq FASTQs to public count-generation workflows and defer post-count matrix QC, annotation, clustering, and UMAP analysis to the embedded scrna-seq-qc skill."
category: bioscience
