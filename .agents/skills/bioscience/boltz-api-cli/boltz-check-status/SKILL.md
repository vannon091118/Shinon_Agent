...
description:  "[codex:boltz-api-cli] Boltz job status and result recovery. Use when listing jobs, checking progress, resuming downloads, recovering results, or downloading an existing job ID. Not for starting new jobs."
category: bioscience
stack: LOGISCH
risk: high
