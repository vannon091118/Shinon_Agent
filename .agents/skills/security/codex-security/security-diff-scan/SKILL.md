...
description: "[codex:codex-security] \"Use when the user asks for a security review of a pull request, commit, branch diff, working-tree patch, or other Git-backed change set.\""
category: security
