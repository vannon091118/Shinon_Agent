...
description: "[codex:test-android-apps] \"Use when validating Android feature flows in an emulator with adb-driven launch, input, UI-tree inspection, screenshots, and logcat capture.\""
category: mobile-dev
