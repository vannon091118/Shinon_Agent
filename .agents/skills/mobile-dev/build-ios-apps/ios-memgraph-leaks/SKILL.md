...
description:  "[codex:build-ios-apps] Capture and inspect iOS leaks and memgraphs. Use when debugging leaked objects, retain cycles, memory growth, or before/after leak evidence."
category: mobile-dev
