...
description:  "[codex:build-ios-apps] Build and refactor SwiftUI UI with component patterns and examples. Use when shaping navigation, state, layouts, controls, or screen composition."
category: mobile-dev
