...
description:  "[codex:build-macos-apps] Prepare macOS packaging and notarization workflows. Use when archiving apps, validating bundles, or explaining distribution-only failures."
category: mobile-dev
