---
name: swiftpm-macos
description:  "[codex:build-macos-apps] Build, run, and test SwiftPM macOS packages and executables. Use when the repo is package-first or has no Xcode project."
category: mobile-dev
