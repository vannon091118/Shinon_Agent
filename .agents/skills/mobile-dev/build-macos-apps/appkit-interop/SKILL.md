---
name: appkit-interop
description:  "[codex:build-macos-apps] Bridge macOS SwiftUI into AppKit narrowly. Use when implementing representables, reaching NSWindow or panels, handling menus, or using the responder chain."
category: mobile-dev
