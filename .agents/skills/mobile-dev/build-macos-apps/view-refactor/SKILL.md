---
name: view-refactor
description:  "[codex:build-macos-apps] Refactor macOS SwiftUI views and scenes into stable structure. Use when splitting large views, tightening scene state, or narrowing AppKit escapes."
category: mobile-dev
