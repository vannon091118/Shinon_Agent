---
name: vercel-shadcn
description:  "[codex:vercel] shadcn/ui expert guidance — CLI, component installation, composition patterns, custom registries, theming, Tailwind CSS integration, and high-quality interface design on Vercel. Distinct from shadcn-best-practices which covers general frontend composition rules. Use when initializing shadcn, adding components, composing product UI, building custom registries, configuring themes, or troubleshooting component issues."
