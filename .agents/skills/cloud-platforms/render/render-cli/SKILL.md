---
name: render-cli
description: "[codex:render] The Render CLI manages services, databases, and deployments from the terminal. Supports interactive use, non-interactive scripting, and CI/CD automation."
