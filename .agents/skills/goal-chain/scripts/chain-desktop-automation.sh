#!/bin/bash
# chain-desktop-automation.sh — STACK: LOGISCH
# Auto-generated wrap of media/desktop-automation/SKILL.md
set -euo pipefail
SCRIPT_DIR="$(cd "$(dirname "${BASH_SOURCE[0]}")" && pwd)"
source "$SCRIPT_DIR/tid-helpers.sh"

RUN_ID="${1:?Usage: bash chain-desktop-automation.sh RUN_ID TID}"
TID="${2:?}"
...
agent_header "$TID" "LOGISCH: desktop-automation"
emit_user_input_start "chain-desktop-automation.sh"

cat <<INSTRUCTION

## Goal: $GOAL
## Skill: $SKILL
## Source: media/desktop-automation/SKILL.md

## Aufgabe
Desktop-Automatisierung. PyAutoGUI/RobotJS. Self-Check: Idempotenz + Screenshots vor/nach.

## Domain-Kontext
- Original-Skill liegt unter: `.agents/skills/media/desktop-automation/SKILL.md`
...
## Agent-Regeln
1. Source-Skills (`.agents/skills/media/desktop-automation/SKILL.md`) NICHT veraendern.
