#!/bin/bash
# chain-typescript-expert.sh — STACK: LOGISCH
# Auto-generated wrap of development/typescript-expert/SKILL.md
set -euo pipefail
SCRIPT_DIR="$(cd "$(dirname "${BASH_SOURCE[0]}")" && pwd)"
source "$SCRIPT_DIR/tid-helpers.sh"

RUN_ID="${1:?Usage: bash chain-typescript-expert.sh RUN_ID TID}"
TID="${2:?}"
...
agent_header "$TID" "LOGISCH: typescript-expert"
emit_user_input_start "chain-typescript-expert.sh"

cat <<INSTRUCTION

## Goal: $GOAL
## Skill: $SKILL
## Source: development/typescript-expert/SKILL.md

## Aufgabe
TypeScript Best-Practices. Type-Safety + Utility-Types + Generic-Constraints. Self-Check: Zero 'any'-Type.

## Domain-Kontext
- Original-Skill liegt unter: `.agents/skills/development/typescript-expert/SKILL.md`
...
## Agent-Regeln
1. Source-Skills (`.agents/skills/development/typescript-expert/SKILL.md`) NICHT veraendern.
