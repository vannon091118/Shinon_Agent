---
name: clerk-webhooks
description:  "Use when building Clerk webhook handlers for real-time events and data syncing, including user, session, organization, billing, and payment events. Verify with verifyWebhook from the framework-specific package. Build event-driven features like database sync, notifications, and integrations."
category: agents
