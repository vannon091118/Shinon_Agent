---
name: teams-messages
description:  "[codex:teams] Compose, route, draft, or send Microsoft Teams messages with exact destination resolution, real user mentions, and Teams-native DM or channel routing."
